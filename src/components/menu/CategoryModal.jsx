...
function CategoryModal({
  ...
  useEffect(() => {
    if (isOpen) {
      setForm(initialValues || { nombre: '', descripcion: '' });
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <button 
            ...
            className="px-6 py-2 rounded-lg bg-[var(--guindo-primario)] text-white hover:opacity-90 transition-opacity font-medium text-sm shadow-sm flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
              <>
